...
7. 锁定一对语义一致的“预期值 / 实际值”后，再调用脚本验证
   ...
   调用方式：
       scripts/vmcore/branches/check_bitflip.sh <expected_value> <actual_value>
   ...
   示例：
       scripts/vmcore/branches/check_bitflip.sh 100 134217828
       scripts/vmcore/branches/check_bitflip.sh 0xDEADBEEF 0xDEACBEEF
       scripts/vmcore/branches/check_bitflip.sh 0xffffffffb3a01000 0xfffffffbb3a01000
